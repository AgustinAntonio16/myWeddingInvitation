...
const Invitacion = () => {
  ...
  return (
    <div className="bg-cover bg-center p-8 rounded-lx text-center mb-8 mt-4 bg-gradient-to-r from-white via-transparent to-white bg-ivoryWhite"
    ...
    >
      ...
      <blockquote className=" bg-white bg-opacity-50 p-8 rounded-lg text-3xl md:text-2xl italic font-GreatVibes text-lightBrown mb-4">
      ...
      <cite className=" bg-white bg-opacity-60 p-8 rounded-lg text-22lx md:text-xl font-GreatVibes text-lightBrown mb-8 block">Corintios 13:4-7</cite>
