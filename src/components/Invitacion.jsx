...
const Invitacion = () => {
  ...
  return (
    <div className="bg-opacity-70 bg-cover bg-center p-8 rounded-lg text-center mb-8 mt-4 bg-gradient-to-r from-white via-transparent to-white bg-ivoryWhite"
    ...
    >
      ...
      <blockquote className="text-3xl md:text-2xl italic font-GreatVibes text-lightBrown mb-4">
      ...
      <strong className='text-emeraldGreen'>{guestName}</strong> Tenemos el honor de invitarte  a nuestra boda
      </p>
    </div>
  );
};
